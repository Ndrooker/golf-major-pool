...
type Props = {
  ...
  onSubmitted: (name: string, picks: string[]) => void
}
...
export function TierList({ tiers, submitUrl, existingNames, prefillFirstName, prefillLastName, onSubmitted }: Props) {
  ...
  const canSubmit = fullName !== '' && allPicked && !submitting
